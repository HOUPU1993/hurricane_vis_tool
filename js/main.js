...
// Called once, lazily, the first time Page 3 (Visualization) is opened.
// Leaflet needs a visible, correctly-sized container at init time, which a
// page that starts as display:none can't give it - so this can't run at
// module load anymore. See js/app.js, which calls this from the router.
