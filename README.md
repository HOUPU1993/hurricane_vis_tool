...
- **Home** - landing screen: the hero question types itself in
  (`js/core/typewriter.js`), a faint evacuation-rate choropleth
...
- `js/core/typewriter.js` - types the homepage hero question in character
  by character, re-run every time the home page is (re)entered
